...
Template( "q_table.csv", row =>
    newTrial( "trial",
        ...
        newImage("ImageName",row.ImageName)
            ...
            .print()
        ,
        newText( `Irene: "W${row[row.WhichQuestion.replace("Mod",row.WhichQuestion+'Question')]}?"` )
            .print()
        ,
        newText(`Sam: "${row[row.WhichAnswer.replace("Answer",row.WhichAnswer+'Answer')]}"`)
            .print()
        ,
        newText( `Irene: "${row.Matrix} w${row[row.WhichQuestion.replace("Mod",row.WhichQuestion+'Question')]}."` )
            .print()
        ,
